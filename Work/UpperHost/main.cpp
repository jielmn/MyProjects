...
void  CDuiFrameWnd::OnBtnSend() {
	...
	const char * pData = "\xFF\xFF\x01\x55\x1A\x00\x01\x01\x45\x52\x00\x00\x03\x00\x00\x00\x00\x00\x01\x59\x3F\xD4\x93\xCD\x59\x02\xE0\x03\x05\x02\x03\xFF\xDD\xAA";
	DWORD  dwDataLen = 34;
