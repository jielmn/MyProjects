...
Page({
  ...
  OnDelete: function(e) {
    ...
    wx.request({
      url: app.globalData.serverAddr + '?type=delete&id=' + id,
      method: 'GET',
      success: (res) => {
  ...
  OnCheckbox: function (e) {
    ...
    wx.request({
      url: app.globalData.serverAddr + '?type=finish&id=' + id,
      method: 'GET',
      success: (res) => {
        if (res.data.error != null && res.data.error == 0) {
  ...
  Register: function() {
    ...
    // 开始注册
    wx.request({
      url: app.globalData.serverAddr + '?type=register&open_id=' + encodeURIComponent(this.data.openid) + '&name=' + encodeURIComponent(this.data.userInfo.nickName) + '&avatarUrl=' +encodeURIComponent(this.data.userInfo.avatarUrl),
      method: 'GET',
      success: (res) => {
        if ( res.data.error != null && res.data.error == 0 ) {
  ...
  GetTodoList:function() {
    ...
    // 开始注册
    wx.request({
      url: app.globalData.serverAddr + '?type=todolist&open_id=' + encodeURIComponent(this.data.openid),
      method: 'GET',
      success: (res) => {
        if (res.data.error != null && res.data.error == 0) {
  ...
  GetHistoryTodoList:function(start_index) {
    ...
    wx.request({
      url: app.globalData.serverAddr + '?type=history&open_id=' + encodeURIComponent(this.data.openid) + '&start_index=' + start_index,
      method: 'GET',
      success: (res) => {
        if (res.data.error != null && res.data.error == 0) {
