...
class CQueryBySmallPkgParam : public LmnToolkits::MessageData {
public:
	CQueryBySmallPkgParam(const char * szSmallPkgId) {
		STRNCPY(m_szSmallPkgId, szSmallPkgId, sizeof(m_szSmallPkgId));
	}
