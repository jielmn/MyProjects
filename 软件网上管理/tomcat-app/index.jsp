...
%>
			<div class="divItem">
				...
				<div class="divContent">
					<div style="height:35px;"><a class="title" style="font-size:20px;" href="detailedItem.jsp?itemid=<%=item_id%>"><b><%=translateHtml(title)%></b></a></div>
				...
				<div class="divDownload"><a class="softDown" href="<%=softwarePath%>">下载</a></div>
			</div>
<%
		} 
		rs.close();
...
%>
			...
			<div class="divItem">
				...
				<div class="divDownload"><a class="softDown" href="abc.text">下载</a></div>
			</div>				
			-->
		</div>
    </body>
